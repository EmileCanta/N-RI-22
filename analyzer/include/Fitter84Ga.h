...
//Double_t l5 = 1.732867951e-4; //82Ge
...
{	
    ...
    {  	
		...
		//+((-exp(-x_2[0]*l1-x_2[0]*l2)*(-1+par_2[2])*(exp(x_2[0]*l1+t0*l2)*l1-exp(x_2[0]*l1+x_2[0]*l2)*l1-exp(t0*l1+x_2[0]*l2)*l2+exp(x_2[0]*l1+x_2[0]*l2)*l2)*par_2[1])/(-l1+l2));
    }
  	...
  	if(x_2[0] >= tc+t0 && x_2[0] <= ta)
    {
		...
		//+((-exp(-x_2[0]*l1-x_2[0]*l2)*(-1+par_2[2])*(-exp(x_2[0]*l1+t0*l2)*l1+exp(x_2[0]*l1+(t0+tc)*l2)*l1+exp(t0*l1+x_2[0]*l2)*l2-exp((t0+tc)*l1+x_2[0]*l2)*l2)*par_2[1])/(l1-l2));
    }
