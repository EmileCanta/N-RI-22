...
Double_t Bateman_tot(Double_t *x, Double_t *par)
{
    ...
    {	
      	return (4.0166)
		+(-exp(-x[0]*l1)*(exp(t0*l1)-exp(x[0]*l1))*201.329);
		//+((-exp(-x[0]*l1-x[0]*l2)*(-1+0.742436)*(exp(x[0]*l1+t0*l2)*l1-exp(x[0]*l1+x[0]*l2)*l1-exp(t0*l1+x[0]*l2)*l2+exp(x[0]*l1+x[0]*l2)*l2)*201.329)/(-l1+l2));
    }
    
  	if(x[0] >= tc+t0 && x[0] <= ta)
    {
     	return (4.0166)
		+(-exp(-x[0]*l1)*(exp(t0*l1)-exp((t0+tc)*l1))*201.329);
		//+((-exp(-x[0]*l1-x[0]*l2)*(-1+0.742436)*(-exp(x[0]*l1+t0*l2)*l1+exp(x[0]*l1+(t0+tc)*l2)*l1+exp(t0*l1+x[0]*l2)*l2-exp((t0+tc)*l1+x[0]*l2)*l2)*201.329)/(l1-l2));
    }
...
{  
	if(x[0] < t0)
    {
  	...
  	if(x[0] >= t0 && x[0] < tc+t0)
    {	
      	return (4.0166)+(-exp(-x[0]*l1)*(exp(t0*l1)-exp(x[0]*l1))*201.329);
    }
    
  	if(x[0] >= tc+t0 && x[0] <= ta)
    {
     	return (4.0166)+(-exp(-x[0]*l1)*(exp(t0*l1)-exp((t0+tc)*l1))*201.329);
    }
...
{  
	if(x[0] < t0)
    {
  	...
  	if(x[0] >= t0 && x[0] < tc+t0)
    {	
      	return (4.0166)+((-exp(-x[0]*l1-x[0]*l2)*(-1+0.742436)*(exp(x[0]*l1+t0*l2)*l1-exp(x[0]*l1+x[0]*l2)*l1-exp(t0*l1+x[0]*l2)*l2+exp(x[0]*l1+x[0]*l2)*l2)*201.329)/(-l1+l2));
    }
    
  	if(x[0] >= tc+t0 && x[0] <= ta)
    {
     	return (4.0166)+((-exp(-x[0]*l1-x[0]*l2)*(-1+0.742436)*(-exp(x[0]*l1+t0*l2)*l1+exp(x[0]*l1+(t0+tc)*l2)*l1+exp(t0*l1+x[0]*l2)*l2-exp((t0+tc)*l1+x[0]*l2)*l2)*201.329)/(l1-l2));
    }
